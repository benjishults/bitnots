...
abstract class VarBindingTerm(cons: TermConstructor, val variable: BoundVariable, val formula: Formula<*>) : Term<TermConstructor>(cons) {
    ...
    override fun applySub(substitution: Substitution): Term<TermConstructor> {
