...
class TptpSynTest {
    ...
    //                     FolFormulaTableauProver(hypothesis?.let {
    //                         Implies(
    //                                 it,
    //                                 target)
    //                     } ?: target, FolUnificationClosingStrategy(), proofConstraints =
    //                     )
    //                     // FolTableau(
    ...
    //         }
    //
    // inner class ResultThread(val tableauProverFol: FolFormulaTableauProver, var result: Result = Result.failed) : Thread(), Future<Result> {
    ...
    //             if (tableauProverFol.findCloser().isDone()) {
