...
"""
        ...
        fun prepareInsertFormulaPlus(
            name: String,
            role: FormulaRoles,
            formula: String,
            problemId: Long,
            pf: PreparedStatement
        ) {
            pf.setString(1, name)
...
//        fun <T> getIds(statement: PreparedStatement, id: String): Collection<T> =
...
//                    connection.prepareStatement(INSERT_FORMULA_PLUS, arrayOf("formula_plus_id"))
//                        .use { insertFormulaPlus ->
//                            @Suppress("UNCHECKED_CAST")
//                            ((problem.axioms
//                                    + problem.conjectures
//                                    + problem.hypotheses)
...
//                                    prepareInsertFormulaPlus(
//                                        annotatedFormula.name,
//                                        annotatedFormula.formulaRole,
//                                        formula,
//                                        problemId,
//                                        insertFormulaPlus
//                                    )
...
//                                    SexpTokenizer(
//                                        it.getString("formula").reader().buffered(),
//                                        "bitnots.formula.formula"
//                                    ), emptySet()
//                                )
//                            )
//                        )
